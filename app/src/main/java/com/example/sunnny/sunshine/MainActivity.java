...
public class MainActivity extends AppCompatActivity {
   ...
   public void updateWeather()
    ...
    class FatchWeatherTask extends AsyncTask<String,Void,String[]> {

        private final String LOG_TAG=FatchWeatherTask.class.getSimpleName();
      ...
      * so for convenience we're breaking it out into its own method now.
        ...
        private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays) throws JSONException
        {
            ...
            /** OWM returns daily forecasts based upon the local time of the city that is being
             ...
             properly Since this data is also sent in-order and the first day is always the
